...
var CookieAccessInfo = require('superagent/node_modules/cookiejar').CookieAccessInfo;
var co = require('co');
...
exports.getSongs = co.wrap(function * ($, type) {
  ...
  // detail page
  // old : http://music.163.com/api/song/detail
  // new : http://music.163.com/weapi/song/detail/
  var url = 'http://music.163.com/weapi/song/detail/';
  ...
  //  
  var query = {};
  var csrf_token_cookie = request.jar.getCookie('__csrf',CookieAccessInfo(
    'music.163.com', // domain
    '/', // path
    false // secure
  ));
  if(csrf_token_cookie && csrf_token_cookie.value){
    query.csrf_token = csrf_token_cookie.value;
  }

  // 
  // post
  //  - params = enc.encData({ ids: [xxxx] }).encText
  //  - encSecKey = ..........................encSecKey
  //  
  var enced = encryptData({
    ids: ids
  });
  var postData = {
    params: enced.encText,
    encSecKey: enced.encSecKey
  };
